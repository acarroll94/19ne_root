...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/c__graphing: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/c__graphing ${OBJECTFILES} ${LDLIBSOPTIONS} `root-config --libs --glibs`

${OBJECTDIR}/function_fit.o: function_fit.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/function_fit.o function_fit.cpp
