...
${OBJECTDIR}/_ext/1149001713/spec16.o: /Research/peaks/spec16.f 
	...
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/_ext/1149001713/spec16.o /Research/peaks/spec16.f

${OBJECTDIR}/_ext/1149001713/spec16b.o: /Research/peaks/spec16b.f 
	${MKDIR} -p ${OBJECTDIR}/_ext/1149001713
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/_ext/1149001713/spec16b.o /Research/peaks/spec16b.f

${OBJECTDIR}/function_fit.o: function_fit.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/function_fit.o function_fit.cpp
